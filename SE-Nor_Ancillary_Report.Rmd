---
title: "<h1 style='font-weight:900;'>Summary Ancillary Data for SE-Nor</h1>
...
df <- read_phenocam("I:/Phenocam/dailyResults/SE-Nor-L08-F01_DB_1000_3day.csv")
...
title(
  main = "Phenocam based phenology for SE-Nor",
  font.main = 2,
  line = 4
)
...
df <- read_phenocam("I:/Phenocam/dailyResults/SE-Nor-L09-F02_DB_1000_3day.csv")
...
title(
  main = "Phenocam based phenology for SE-Nor (below canopy)",
  font.main = 2,
  line = 4
)
