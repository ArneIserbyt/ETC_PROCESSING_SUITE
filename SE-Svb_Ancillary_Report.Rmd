---
title: "<h1 style='font-weight:900;'>Summary Ancillary Data for SE-Svb</h1>
...
library(dplyr)
 ...
 df <- read_phenocam("I:/Phenocam/SE-Svb/ROI/SE-Svb_EN_1008_3dayb.csv")
...
title(main = "Phenocam based phenology for SE-Svb", font.main = 2, line = 4)
...
- large data gaps (mid june 2022 - early april 2023).

- Due to snow and darkness, many points excluded in winter.

- Years 2024 and 2025 still to analyse.

- Resolution hourly. 12images/day untill june 2022 - 24 images/day from mid april 2023 onwards.
...
df1 <- read_phenocam("I:/Phenocam/SE-Svb-BC/ROI/SE-Svb-BC_DB_1000_3day.csv")
df2 <- read_phenocam("I:/Phenocam/SE-Svb-BC/ROI/SE-Svb-BC_DB_1001_3day.csv")
 

df3 <- df1
df3$data <- bind_rows(df1$data, df2$data)
...
title(main = "Phenocam based phenology SE-Svb (below canopy)", font.main = 2, line = 4)
mtext("Date", side = 1, line = 2.5, font = 2)  
mtext("Green chromatic coordinate (Gcc_mean)", side = 2, line = 2.5, font = 2)  
